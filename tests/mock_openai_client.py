...
class MockCompletion:
    """Minimal completion container used by the mock client."""
...
class MockCompletionResponse:
    """Response wrapper that mirrors the OpenAI choices shape."""
...
class MockChatCompletions:
    ...
    def create(
        ...
        """Return a mock chat completion response for the given messages."""
        self.call_count += 1
...
class MockCompletions:
    """Mock completions endpoint for testing."""
    ...
    def create(self, model: str, prompt: str, **kwargs) -> MockCompletionResponse:
        """Return a mock completion response for the given prompt."""
        self.call_count += 1
